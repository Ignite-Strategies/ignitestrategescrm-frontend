...
export default function SequenceCreator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Require campaignId - no automatic campaign creation
      const campaignId = searchParams.get('campaignId');
      
      if (!campaignId) {
        setError("No campaign selected. Please go to Campaign Home and select a campaign first.");
        alert("❌ No campaign selected. Please go to Campaign Home and select a campaign first.");
        return;
      }
