      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-xl border-2 border-indigo-200 hover:border-indigo-400 transition cursor-pointer"
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">📊 BULK</h2>
                  <p className="text-lg text-gray-600">Campaigns to Lists</p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-8 rounded-xl border-2 border-emerald-200 hover:border-emerald-400 transition cursor-pointer"
                 onClick={() => navigate("/email/outreach")}>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-emerald-500 text-white rounded-xl flex items-center justify-center mr-4">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                  </svg>
                </div>
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">🎯 1:1</h2>
                  <p className="text-lg text-gray-600">Personal Outreach</p>
                </div>
              </div>
          ...
          <div className="border-t pt-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Supporting Tools</h3>
            ...
            >
              ...
              <p className="text-sm text-purple-700">Create reusable email templates for campaigns and outreach</p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-blue-700">Create and manage contact lists for campaigns</p>
            </button>
