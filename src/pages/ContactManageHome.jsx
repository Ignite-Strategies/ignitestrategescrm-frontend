        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">💡 The HubSpot Killer</h4>
                <p className="text-sm text-blue-800">
                  Upload contacts fast (name, email, phone) → Map to pipeline on ingest → Done. No endless forms upfront.
                </p>
              </div>
            </div>
          </div>
